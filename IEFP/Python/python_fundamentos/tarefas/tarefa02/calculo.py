...
def calcDia(anoAtual , anoDado):
    dias = 0
    if anoAtual > anoDado and anoAtual - anoDado != 1:
        for ano in range(anoDado, anoAtual - 1):
            if ((ano % 4 == 0 and ano % 100 != 0) or (ano % 400 == 0)):
                dias += 366
            else:
                dias += 365
    else:
        for ano in range(anoAtual, anoDado):
            if ((ano % 4 == 0 and ano % 100 != 0) or (ano % 400 == 0)):
                dias -= 366
            else:
                dias -= 365
